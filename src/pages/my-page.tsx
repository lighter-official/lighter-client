...
export default function Writer() {
    ...
    return (
        <div className="flex flex-col my-[50px] w-full">
            ...
            <a className='cursor-pointer font-bold' style={{color:'#191919'}}onClick={()=>router.push('/my-page')}>나의 보관함</a>
                    ...
                    <div className='flex mt-[20px] justify-between flex-row my-[30px]'>
                        <div className='bg-black rounded-sm  flex flex-col w-[400px] h-[471px]'>
                            <div className='flex flex-col mx-[20px]'>
                                ...
                                <div className='flex flex-col gap-y-[26px] mt-[24px]'>
                                    <div className='flex text-[20px] font-bold' style={{ color: '#CEB292' }}>내가 발행한 책</div>
                                    <div className='flex text-[20px]' style={{ color: '#CEB292' }}>못다쓴 책</div>
                                    <div className='flex text-[20px]' style={{ color: '#CEB292' }}>나의 뱃지</div>
                                    <div className='flex text-[20px]' style={{ color: '#CEB292' }}>설정</div>
                        ...
                        <div className='w-[1120px] rounded-sm border-black border-1 flex flex-row max-h-[797px]' style={{ backgroundColor: '#E0D5BF' }}>
                            <div className='w-full  my-[30px] ml-[53px]'>
                               ...
                               <div className='w-[205px] text-black mt-[8px] text-[36px] font-bold'>내가 발행한 책</div> <div className='w-[83px] h-[49px] text-[36px] justify-end'>(2)</div>
                                ...
                                <div className='flex flex-col  max-h-[643px] overflow-y-auto mt-[21px] mb-[21px] '>
                                    <div className=' mt-[53px] flex flex-row gap-x-[46px]'>
                                        <div>
                                            <div className='w-[266px] h-[370px]' style={{backgroundColor: '#D5C8AE'}}></div>
