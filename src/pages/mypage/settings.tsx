                        ...
                        <div className='bg-black rounded-sm  flex flex-col w-[400px] h-[471px]'>
                            <div className='flex flex-col mx-[20px]'>
                                ...
                                <div className='flex text-[20px] cursor-pointer' style={{ color: '#CEB292' }} onClick={()=>router.push('/mypage/badge')}>나의 뱃지</div>
                                    ...
                                    <div className='flex text-[20px] font-bold cursor-pointer' style={{ color: '#CEB292' }}  onClick={()=>router.push('/mypage/settings')}>설정</div>
                            ...
                            <div className='w-full  my-[30px] ml-[53px] '>
                               ...
                               <div className='w-[205px] text-black mt-[8px] text-[36px] font-bold'>설정</div>
                                   ...
                                   <div className='w-[130px] flex flex-row gap-x-[4px]'>
                                    <button className='rounded-md mx-auto mt-[30px] w-[64px] h-[30px] bg-white' style={{ border: '1px solid gray'}}>AM</button>
                                   <button className='rounded-md mx-auto mt-[30px] w-[64px] h-[30px] bg-black text-white'>PM</button>
                                   </div>
